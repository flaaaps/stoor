...
export default function Home({ products, collections }: { products: IProduct[]; collections: ICollection[] }) {
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h1 className={styles.title}>
                    Welcome to <span>Prepared To Die</span>
                </h1>
                    ...
                    {collections.map(collection => (
                        <div key={collection.id} style={{ marginBottom: "2rem" }}>
                            <h1 className={styles.collectionName}>
                                <Link href={`/collection/${collection.identifier}`}>{collection.name}</Link>
                            </h1>
